...
namespace icrar
{
    ...
    protected:
        ...
        void CalibrateTest(ComputeImplementation impl, const ComputeOptions computeOptions, const Slice solutionInterval, std::function<cpu::CalibrationCollection()> getExpected)
        {
