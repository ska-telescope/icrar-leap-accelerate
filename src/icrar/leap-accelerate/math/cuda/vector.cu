...
namespace cuda
{
    void add(size_t n, const double* a, const double* b, double* c) { h_addp(n, a, b, c); }
    ...
    void add(const Eigen::VectorXd& a, const Eigen::VectorXd& b, Eigen::VectorXd& c) { h_add<double, Eigen::Dynamic, 1>(a, b, c); }
    void add(const Eigen::VectorXf& a, const Eigen::VectorXf& b, Eigen::VectorXf& c) { h_add<float, Eigen::Dynamic, 1>(a, b, c); }
    void add(const Eigen::VectorXi& a, const Eigen::VectorXi& b, Eigen::VectorXi& c) { h_add<int, Eigen::Dynamic, 1>(a, b, c); }
