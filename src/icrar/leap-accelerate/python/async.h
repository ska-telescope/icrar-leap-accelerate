...
class Awaitable {
    public:
        ...
        Awaitable(std::future<pybind11::object>& _future) : future(std::move(_future)) {};
...
pybind11::class_<Awaitable> enable_async(pybind11::module m) {
    return pybind11::class_<Awaitable>(m, "Awaitable")
        .def(pybind11::init<>())
