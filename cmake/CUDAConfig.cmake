...
function(configure_nvcc_cuda_compiler TARGET_NAME)
  ...
  if(CUDA_LEVEL STREQUAL "")
    ...
    list(FIND CUDA_LEVEL "60" CUDA_LEVEL_60)
    list(FIND CUDA_LEVEL "61" CUDA_LEVEL_61)
    list(FIND CUDA_LEVEL "70" CUDA_LEVEL_70)
    list(FIND CUDA_LEVEL "72" CUDA_LEVEL_72)
    list(FIND CUDA_LEVEL "75" CUDA_LEVEL_75)
    list(FIND CUDA_LEVEL "80" CUDA_LEVEL_80)
    list(FIND CUDA_LEVEL "86" CUDA_LEVEL_86)
  endif()
...
function(configure_cuda_warnings TARGET_NAME)
  ...
  if(CUDA_VERSION_STRING VERSION_GREATER 10)
    ...
    target_compile_options(${TARGET_NAME} PRIVATE $<$<COMPILE_LANGUAGE:CUDA>:-Xcudafe="--diag_suppress=3057,2929,20012">)
  endif()
endfunction()